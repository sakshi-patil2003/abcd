...
function CompTestimonials() {
  ...
  return (
    <div className="px-4 md:px-10">
      <h2 className="text-3xl md:text-4xl mt-4 font-semibold text-[#ff7f4f] text-center">
          ...
          {testimonials.map((testimonial, i) => (
            <div key={i} className="p-2">
              <div
                ...
                className="border-4 border-[#ff7f4f] rounded-lg p-4 sm:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 w-[90%] sm:w-auto mx-auto sm:mx-0"
              ...
              >
                ...
                <p className="text-lg font-semibold text-[#ff7f4f] text-center">{testimonial.name}</p>
                <p className="text-sm text-[#4e4e4e] text-center">
                  {testimonial.department} | {testimonial.year}
                </p>
                <hr className="my-1 border-t border-[#ff7f4f]" />
