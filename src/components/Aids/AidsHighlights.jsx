  ...
  return (
    ...
    >
      <div className="px-8 md:px-16 py-6">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 poppins-bold text-black">ICEM Highlights</h1> {/* Use bold for the heading */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-8">
          {/* Card 1 */}
          <div className="bg-[#F6FBFF] p-3 md:p-6 shadow-lg text-left overflow-hidden">
            ...
            <p className="text-gray-600 poppins-regular text-rust-700">
