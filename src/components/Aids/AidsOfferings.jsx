...
import offer1Image from '../../assets/images/AIDS-Imagegs/aids-off-6.avif';  // Keep the original image path
import offer2Image from '../../assets/images/AIDS-Imagegs/aids-off-4.avif';  // Keep the original image path
import offer3Image from '../../assets/images/AIDS-Imagegs/aids-off-3.avif';  // Keep the original image path
import offer4Image from '../../assets/images/AIDS-Imagegs/aids-off-5.avif';  // Keep the original image path
import offer5Image from '../../assets/images/AIDS-Imagegs/aids-off-2.avif';  // Keep the original image path
import offer6Image from '../../assets/images/AIDS-Imagegs/aids-off-1.avif';  // Keep the original image path
