...
function BcaStudying() {
  ...
  return (
    <div className="flex flex-col md:flex-row px-8 md:px-16 py-6 poppins-regular bg-[#F5F0EB]">
      {/* 70% Left Side */}
      <div className="w-full md:w-[70%] pr-0 md:pr-8" data-aos="fade-right">
        ...
        <div className="grid grid-cols-2 grid-rows-3 gap-2">
          {/* Card 1 */}
          <div className="bg-[#FCFAEE] p-8 shadow-lg shadow-blue-500/20 flex justify-between items-center rounded-lg" data-aos="zoom-in">
