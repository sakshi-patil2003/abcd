...
const IntegratedBcaMcaBanner = () => {
  ...
  return (
    <div className="py-4 md:py-4 px-8 sm:px-12 shadow-lg transform transition-all duration-700 ease-in-out bg-[#F5F0EB]">
      <div className="mx-auto text-center">
        ...
        <button
  onClick={scrollToTop}
  className="bg-[#FCFAEE] text-[#555] font-bold py-3 px-8 rounded-full bordrer border-2 shadow-lg hover:bg-[#1D4ED8] hover:text-white transition-all duration-300 ease-in-out"
  style={{
