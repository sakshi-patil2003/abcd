  ...
  return (
    <div className="px-8 md:px-16 pt-8 poppins-regular">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-16">
        ...
        <div
          className="bg-[#e1f1fb] p-2 z-10 shadow-lg flex items-center justify-center"
        ...
        >
          <div className="flex flex-col items-center justify-center ">
            ...
            <div className="text-center">
              ...
              <p className=" text-2xl font-semibold text-[#001E5D]">Offline</p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col items-center justify-center ">
            ...
            <div className="text-center">
              ...
              <p className=" text-2xl font-semibold text-[#001E5D]">4 Years</p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col items-center justify-center ">
            ...
            <div className="text-center">
              ...
              <p className=" text-2xl font-semibold text-[#001E5D]">Rs. 120000/-</p>
            </div>
          </div>
        </div>
      </div>
