...
const CompCarrer = () => {
  return (
    <div className="bg-[#390161]  py-16 px-8 sm:px-12 shadow-lg transform transition-all duration-700 ease-in-out">
      <div className="max-w-7xl mx-auto text-center">
        ...
        {/* Logos Section */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:px-8">
          <div className="flex justify-center items-center p-4 hover:scale-110 transition-transform duration-300 ease-in-out">
