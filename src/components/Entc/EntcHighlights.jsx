  ...
  return (
    ...
    >
      <div className="px-6 md:px-16 py-6">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 poppins-bold text-[#266670]">
          ICEM Highlights
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          ...
          {[ 
            ...
            { icon: faCertificate, text: 'ICEM has been accredited with ‘B++’ grade by National Accreditation and Assessment Council (NAAC).' }
          ].map((item, index) => (
            <div key={index} className="bg-[#F6FBFF] p-4 md:p-6 shadow-lg text-center rounded-lg flex flex-col items-center">
