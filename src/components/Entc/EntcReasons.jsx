function ItReasons() {
  return (
    <div className="px-6 md:px-10 lg:px-16 py-8 bg-gradient-to-br from-[#03918a] to-[#089D8A]">
      <h2 className="text-3xl md:text-4xl lg:text-4xl font-bold text-center text-white mb-6">
        Why Choose ICEM for Your IT Engineering Journey?
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white shadow-md p-6 text-center rounded-lg hover:shadow-xl transition-shadow">
