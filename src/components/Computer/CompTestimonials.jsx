  ...
  return (
    <div className="px-4 md:px-16 overflow-hidden">
          ...
          {combinedData.map((item, index) => (
            <div key={index} className="py-8 px-8">
              <div
                ...
                className="relative border-4 border-[#6095ff] rounded-lg p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 w-[90%] sm:w-auto mx-auto"
                style={{
              ...
              >
                {item.type === "journey" && (
                  <div className="absolute top-[-30px] left-[-30px] w-32 h-32 rounded-full overflow-hidden border-2 border-[#6095ff] shadow-md bg-white z-10">
                    <img
                ...
                <p className="text-lg font-semibold text-[#6095ff] text-center">
                  {item.data.name}
                </p>
                ...
                <hr className="my-2 border-t border-[#6095ff]" />
      ...
      <div className="bg-white shadow-lg overflow-hidden  block md:hidden">
        ...
        <h2 className="text-3xl md:text-4xl  font-semibold text-[#6095ff] text-center">
        What Our Students Say & Alumni Journeys
        </h2>
        <Slider {...sliderSettings}>
          {combinedData.map((item, index) => (
