    ...
    <div className="py-4 md:py-8 px-8 sm:px-12 rounded-lg shadow-lg transform transition-all duration-700 ease-in-out">
      <div className=" mx-auto text-center">
        ...
        <div className="flex justify-center mb-4">
          <button className="bg-[#F7F0FC] text-[#161e3a] font-bold py-3 px-8 rounded-full shadow-lg hover:bg-[#2241ac] hover:text-[#F7F0FC] transition-all duration-300 ease-in-out">
            Learn More
          </button>
        </div>
      </div>
